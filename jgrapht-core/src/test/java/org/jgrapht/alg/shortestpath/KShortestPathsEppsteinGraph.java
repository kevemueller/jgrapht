...
/**
 * A graph used in Eppstein's paper.
 *
 */
public class KShortestPathsEppsteinGraph
    extends DirectedWeightedPseudograph<String, DefaultWeightedEdge>
{
    private static final long serialVersionUID = 4784241694367922869L;

    /**
     * Create the instance and populate it with the vertices and edges.
     */
